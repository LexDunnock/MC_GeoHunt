...
/**
 *  This is the character activity. The user can create "herself" or "himself"
 */
public class CharacterActivity extends AppCompatActivity {
    ...
    /**
     * The method OnCreate starts the character activity.
     * The user can make his "face" with different choices
     *
     * @param savedInstanceState actual instance of activity
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgButtonFace1.setOnClickListener(new View.OnClickListener() {
            /**
             * for every onClick method in this activity:
             * with clicking on it, you see the actual face which will be saved if you go back to
             * the stary activity
             * @param v view shows an image
             */
            @Override
    ...
    /**
     * This method shows the actual image of the player after the setting
     */
    @Override
